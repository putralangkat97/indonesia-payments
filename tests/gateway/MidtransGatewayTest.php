...
class MidtransGatewayTest extends TestCase
{
    ...
    private string $serverKey = "SB-Mid-server-test123";
    ...
    public function test_charge_creates_snap_transaction(): void
    {
        ...
        $this->client
            ...
            ->with($this->callback(function (array $payload) {
                return $payload["transaction_details"]["order_id"] === "ORDER-001"
    ...
    public function test_handle_webhook_with_valid_signature(): void
    {
        ...
        $signature = hash(
            "sha512",
            $order_id . $status_code . $gross_amount . $this->serverKey,
        );
    ...
    public function test_map_status(string $midtransStatus, PaymentStatus $expected): void
    {
        $this->client
            ->method("getTransactionStatus")
            ->willReturn([
